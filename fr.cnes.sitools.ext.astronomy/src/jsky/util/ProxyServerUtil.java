/*
 * $Id: ProxyServerUtil.java,v 1.4 2009/04/21 13:31:17 abrighto Exp $
 */
...
public class ProxyServerUtil {
    ...
    public static void init() {
        ...
        if (httpNonProxyHosts != null
                && !httpNonProxyHosts.equals(httpNonProxyHostsOption)
        ...
        if (httpsNonProxyHosts != null
                && !httpsNonProxyHosts.equals(httpsNonProxyHostsOption)
