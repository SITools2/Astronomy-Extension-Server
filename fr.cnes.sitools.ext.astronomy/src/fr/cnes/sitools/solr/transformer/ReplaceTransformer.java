 ...
 *
 * <p>
 * The DIH extracts data and it organizes data by the use of attributes called
 * "field". Each field is considered as a column. Each column can be processed
 * by this transformer. Thus, to use this transformer, set to a field the
 * following attributes:
 * <ul>
 * <li>column, name of the column that has been previouly extracted by the
 * DIH</li> <li>name, name of the field</li>
 ...
 *
 * <p>
 * Here is an example how to configure the DIH configuration file
 * <pre><code><field column="..." name="..." replace="..." by="..."/></code></pre>
 * </p>
 *
