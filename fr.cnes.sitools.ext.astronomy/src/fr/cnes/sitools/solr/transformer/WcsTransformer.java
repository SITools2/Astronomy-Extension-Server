 ...
 *
 * <p>
 * When WCS keywords exist, the DIH computes:
 * <ul>
 ...
 *
 * <p>
 * To set up the Healpix configuration, some attributes must be set to entity
 * tag:
 * <ul>
 * <li>transformer, transformer name</li>
 * <li>minOrder (optional, default: 0), minimum order for which Healpix is
 * computed</li>
 * <li>maxOrder (optional, default: 13), maximum order for which Healpix is
 * computed</li>
 ...
 *
 * <p>
 * To map, a solrColumn with a wcs element, configure the solr fields as follow
 * <field column="<name>" ... wcs="..."/> where wcs keyword can take the
 * following values :
 * NAXIS1,NAXIS2,EQUINOX,CTYPE1,CTYPE2,CRPIX1,CRPIX2,CRVAL1,CRVAL2,CDELT1,CDELT2
 * CROTA1,CROTA2,CD1_1,CD1_2,CD2_1,CD2_2,DATE-OBS,EPOCH,RADECSYS Moreover, three
 * new columns are added (ra, dec, coordinates) and can be used in SOLR schema
 *
 * About Healpix index, new columns are computed: <field column="<name>" .../>
 * where <name> is from order0 to order13 </p>
 *
...
public class WcsTransformer extends Transformer implements WCSKeywordProvider {
     ...
     *
     * <p>
     * This transformer computes the footprint and its Healpix index.</p>
     *
     *
     ...
     * <code>RA_WCS</code> or
     * <code>DEC_WCS</code> cannot be retrieved.</p>
     *
    ...
    /**
     * Returns
     * <code>true</code> if the xml-data-config file contains attributes with a
     * specific wcs key.
     *
     * @param field field
    ...
    /**
     * Computes and stores the center of the image in
     * <code>row</code>.
     *
     * @param wcs wcs
     */
