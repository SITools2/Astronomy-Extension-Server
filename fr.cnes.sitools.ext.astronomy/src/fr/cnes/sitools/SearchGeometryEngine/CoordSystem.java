...
public enum CoordSystem {
     ...
     * @return phi in decimal degree
     */
    public static double convertRaToPhi(final double ra) {
         return ra;
    }
     ...
     * @return theta in decimal degree
     */
    public static double convertDecToTheta(final double dec) {
        return ANGLE_DIFFERENCE_POLAR_VS_EQUATOR - dec;
    }
