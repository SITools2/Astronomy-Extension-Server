...
public class AstroCoordinate {
     ...
     * Creates a point on the sphere.
     *
     * @param raStr Right ascension in sexagesimal in format H:M:S.sss or H M
     * S.sss.
     * @param decStr Declination in sexagesimal in format D:M:S.sss or D M
     * S.sss.
     ...
     *
     * @param coordSystemVal the coordinate system that is used for the stored
     * coordinates
     */
    ...
    /**
     * Converts the sky position of an object from a reference frame to another
     * one.
     *
     * <p>
     * if the reference frame is not supported or a conversion problem occurs, a
     * RuntimeException is raised.</p>
     *
     ...
     *
     * <p>
     * A RuntimeException is raised when a problem occurs during the conversion,
     * including a not supported coordinate system.</p>
     *
     ...
     *
     * @return <code>True</code> if come complementaty is defined otherwise
     * <code>false</code>
     */
    ...
    /**
     * Displays the coordinates as follows: Coordinate: (ra_decimal,dec_decimal)
