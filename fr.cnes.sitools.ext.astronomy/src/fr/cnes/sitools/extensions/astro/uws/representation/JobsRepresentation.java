 ...
 */
public class JobsRepresentation extends fr.cnes.sitools.extensions.astro.uws.representation.XstreamRepresentation {
        ...
        while (iterJobTasks.hasNext()) {
            ...
            if (isUsedDestructionDate) {
                try {
                    ...
                    try {
                        calendar = fr.cnes.sitools.extensions.astro.uws.common.Util.convertIntoXMLGregorian(currentDate);
