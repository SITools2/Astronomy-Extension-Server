 ...
 * @startuml reverseNameResolver-usecase.png
 * title Reverse Name Resolver
 * User --> (Reverse Name Resolver) : requests
 * Admin --> (Reverse Name Resolver) : adds and configures the Reverse Name Resolver.
 * (Reverse Name Resolver) .. (project) : uses
 * @enduml
 * @startuml
 * package "Services" {
 *  HTTP - [ReverseNameResolverResourcePlugin]
 * }
 * cloud {
 * [CDS]
 * }
