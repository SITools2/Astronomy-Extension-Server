...
public class SkyCoverageResource extends SitoolsParameterizedResource {
    ...
    /**
     * Transforms the value of the sky coverage in percent. This constant
     * inputStream used when the TXT representation inputStream called
     */
    private static final int NORMALIZE_TO_PERCENT = 100;
    /**
     * Default opacity (0.1) for coodinates. This constant inputStream used when
     * the PNG representation inputStream called
     */
    private static final float DEFAULT_OPACITY_COORDINATES = 0.1f;
    /**
     * Default opacity (1.0) for MOC. This constant inputStream used when the
     * PNG representation inputStream called
     */
    private static final float DEFAULT_OPACITY_MOC = 1.0f;
    /**
     * Default PNG width. This constant inputStream used when the PNG
     * representation inputStream called
     */
    private static final int DEFAULT_GRAPH_WIDTH = 800;
    /**
     * Default PNG height. This constant inputStream used when the PNG
     * representation inputStream called
     */
    ...
    /**
     * Computes the sky coverage with a list of MOC's URLs and stores the result
     * in moc variable.
     *
     * @param mocArray List of MOC's URL.
     * @throws Exception if an error occurs during the Healpix processing, if
     * the URL inputStream malformed or if an error occurs when getting the
     * result as a stream
     */
     ...
     * @return the MOC
     * @throws Exception if an error occurs during the Healpix processing or
     * when getting the stream
     */
