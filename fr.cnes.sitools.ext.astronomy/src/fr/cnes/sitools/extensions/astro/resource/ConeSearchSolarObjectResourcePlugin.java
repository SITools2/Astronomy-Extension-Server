 ...
 *
 * <p>
 * This service queries the Skybot service from IMCCE with Healpix (Healpix
 * number + order) and a given time. The response is a list of solar objects
 ...
 * at the acquisition time of my image in order to detect or analyse system
 * solar objects.
 * <br/>
 * <img
 * src="../../../../../../images/ConeSearchSolarObjectResolver-usecase.png"/>
 * <br/>
 * </p>
 * <p>
 ...
 * @startuml ConeSearchSolarObjectResolver-usecase.png title Name Resolver User
 * --> (ConeSearch Solar Object Resolver) : requests Admin --> (ConeSearch Solar
 * Object Resolver) : adds and configures the Name Resolver. (ConeSearch Solar
 * Object Resolver) .. (project) : uses
 * @enduml
 * @startuml package "Services" { HTTP -
 * [ConeSearchSolarObjectResolverResourcePlugin] [Cache] } cloud { [IMCCE] }
 * package "Project/Dataset" { HTTP - [Project/Dataset] }
 * [ConeSearchSolarObjectResolverResourcePlugin] --> [Project/Dataset] :
 * "attached to" [ConeSearchSolarObjectResolverResourcePlugin] --> [IMCCE] :
 * "uses" [ConeSearchSolarObjectResolverResourcePlugin] .. [Cache]
 * @enduml
 */
