        ...
        <TABLEDATA>           
            ...
            <TR>               
              <#list sqlColAlias as sqlcol>
                <#if row["${sqlcol}"] == "null"><TD/><#else><TD>${row["${sqlcol}"]}</TD></#if>
              </#list>
            </TR>
            </#list>
        </TABLEDATA>
