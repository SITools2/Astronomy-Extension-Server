...
public final class ShortArray extends Array {
   private short [] array;    // Array of shorts (real size is given by "size")
   ...
   /** Deep copy */
   public Array clone() {
      ShortArray a = new ShortArray(sizeBloc);
      if( array==null ) a.array=null;
      else {
         a.array = new short[array.length];
   ...
   public boolean equals(Array a) {
      ...
      for( int i=0; i<size; i++ ) {
         if( array[i]!=((ShortArray)a).array[i] ) return false;
      }
      return true;
   }
    ...
    */
   public short [] seeArray() { return array; }
   
   public long get(int i) { return array[i]; }
   
   public void set(int i,long v) { array[i]=(short)v; }

   /** Size of the array in bytes */
   public long getMem() { return 9+(array==null?0:array.length*2); }
   
   public int geSize() { return size; }
    ...
    */
   public boolean add(long v,boolean testUnicity) { return add((short)v,testUnicity); }
    ...
    */
   public boolean delete(long v) { return delete((short)v); }
    ...
    */
   public boolean delete(long v1,long v2) { return delete((short)v1,(short)v2); }
    ...
    */
   public boolean deleteBrothers(long me) { return deleteBrothers((short)me); }
   public boolean deleteBrothers(short me) {
      int firstBrother = me - me%4;
      int pos[] = new int[3];
      
      // Search three other brothers
      for( int j=0,i=0; j<3 && i<4; i++,j++ ) {
      ...
      if( sorted ) {
         ...
         for( int i=0; i<3; i++ ) array[ pos[i] ] = array[ size-1-i ];
      }
      size-=3;
      return true;
   }
    ...
    */
   public int find(long v) { return find( (short)v ); }
   ...
   public boolean intersectRange(long vStart, long vEnd) { 
      return intersectRange((short)vStart,(short)vEnd);
   }
   ...
   private void adjustSize(int n) {
      ...
      short [] nArray = new short[ (1+ (size+n)/sizeBloc) * sizeBloc ];
