 ...
 */
public abstract class AbstractExportVOResourceTest extends AbstractSitoolsServiceTestCase {
  ...
  public void setUp() {
    try {
      ...
      Logger.getLogger(AbstractExportVOResourceTest.class.getName()).log(Level.SEVERE, null, ex);
